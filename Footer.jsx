					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/_justtfdl/" class="hover:underline">
										FADEL
									</a>
								</li>
								<li>
									<a href="https://www.instagram.com/danang.25200/" class="hover:underline">
										DANANG
									</a>
								</li>
							</ul>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/xisoftwarefive/" class="hover:underline ">
										Instagram
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas XII RPL 5| Di Kelola Oleh Siswa RPL 5
						</p>
					</div>
				</div>
			</div>
