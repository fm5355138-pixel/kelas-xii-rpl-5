	...
	return (
		<div className="z-1 relative h-auto lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="Yeva Purnama S.Pdi" Width="150px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex relative top-[-3rem]" data-aos="fade-up" data-aos-duration="1200">
					<div className="relative left-[0.2rem]">
						<BorderStruktur Jabatan="Ketua Kelas" Nama="Fadel" Width="120px" />
					</div>
					...
					<div className="relative right-[0.2rem]">
						<BorderStruktur Jabatan="Wakil Ketua" Nama="Wahyu" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Sekertaris" Nama="Mufidah" Width="120px" />
						<div className="py-[3%]"></div>
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Bendahara" Nama="Kesya" Width="120px" />
						<div className="py-[3%]"></div>
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Keamanan" Nama="Fathan" Width="120px" />
						<div className="py-[3%]"></div>
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Kebersihan" Nama="Bella" Width="120px" />
						<div className="py-[3%]"></div>
					</div>
